            ...
            <div className="col-md-8">
                <div className="card-body">
                    <h3 className="card-title">{hotel.title} 
                        <span className='float-right text-primary m-4'>
                            {currencyFormatter({
                    ...
                    <p className='card-text'>
                        <span className='float-right text-primary'>
                            for {diffDays(hotel.from, hotel.to)} {diffDays(hotel.from, hotel.day) <= 1 ? ' day' : ' days'}
                        </span>
                    </p>
                    <p className='card-text'>
                        {hotel.bed} bed
                    ...
                    {showModal && <OrderModal session={session} orderedBy={orderedBy} showModal={showModal} setShowModal={setShowModal} />}
                     ...
                     <div className='d-flex justify-content-between h4'>
                        <button 
                            ...
                            className='btn btn-primary'>Show Payment Info
                        </button> 
